                ...
                <div className='text-white'>
                    <div className='text-center mx-auto max-w-screen-lg'>
                        <h1 className='second md:text-5xl text-4xl tracking-wider duration-500'>
                            Empowering Every Journey with Fast and Ultra-Fast Charging
                        </h1>
                        <p className='second font-sans pt-3 tracking-widest text-[#64FFAF]'>
                            CHARGINITY
                        </p>
                    </div>
                    <div className='third md:pt-5 pt-5 pb-5 md:pb-0 md:text-2xl text-lg tracking-wider max-w-screen-lg justify-center text-center mx-auto duration-500'>
                        ...
                        <a 
                            href="#about" className="fourth text-[#fff] md:text-base text-xs font-semibold scroll-smooth duration-500 hover:border-[#64FFAF] hover:text-[#64FFAF] border-transparent border mx-auto items-center relative h-10 tracking-wider uppercase px-4 w-full max-w-xs justify-center text-center flex rounded-sm">
                            Learn More
                        </a>
                    </div>
                </div>
