...
const Footer = () => {
    return (
        <div className='bg-[#1F242C]'>
            <div className='max-w-screen-xl mx-auto text-center justify-between py-10 md:px-10 pb-10 px-5'>
                <div className='md:flex md:grid-cols-3 md:max-w-full md:mx-auto md:justify-between py-5 text-white'>
                    <div className='md:pt-8 md:py-16 block md:hidden'>
                        <div className="py-2 md:px-0 text-center mx-auto justify-center">
                            <a href="/">
                                <img src='./white-logo.png' className='md:w-80 w-44 md:mx-auto justify-center md:text-center' alt='favicon.png'/>
                            </a>
                        </div>
                    </div>
                    <div className='md:pt-8 md:py-16 max-w-xs'>
                    ...
                    <div className='md:pt-8 pt-8 md:py-16'>
                        ...
                        <div className="flex flex-row gap-7 pt-2 md:text-center mx-auto text-left">
                            ...
                            <a 
                                target="_black" href="" 
                                className="items-center text-sm relative h-8 pt-0.5 uppercase duration-200 flex justify-center flex-row hover:text-[#26C774] active:text-[#26C774]"
                                rel="noreferrer">
