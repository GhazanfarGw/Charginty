...
function Logo({ isScrolled }) {
  ...
  return (
    <>
      ...
      {isScrolled ? (
      <header className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center bg-[#fff] overflow-x-hidden shadow-md md:py-2 scroll-smooth border-opacity-40 border-b border-[#08CEAB]">
          ...
          <div className="flex items-center">
            <div className="flex items-center max-w-screen-2xl justify-between mx-auto w-full">
              <div className="flex-shrink-0 py-2 items-center duration-500">
                <a href="/">
                  <img width={160} className='hidden md:block lg:block items-center duration-500' src='./color-logo.png' alt='favicon.png'/>
                  <img width={150} className='block md:hidden lg:hidden items-center duration-500' src='./color-logo.png' alt='favicon.png'/>
                </a>
              </div>
                ...
                <div className="items-center flex duration-500 justify-end mx-auto gap-x-10">
                  <div className='flex pl-8 items-center'>
                    <a
                      ...
                      items-center text-base md:hover:border-b border-[#08CEAB] relative h-8 pt-0.5 duration-200 lg:px-4 md:px-2 px-4 flex justify-center flex-row text-[#000] tracking-wide"
                    >
                      Home
                    </a>
                  </div>
                  <div>
                    <a 
                      href="/quote" className="items-center text-base md:hover:border-b bg-[#08CEAB] border-[#08CEAB] relative h-8 pt-0.5 duration-200 md:px-4 rounded-lg px-4 flex justify-center flex-row text-[#000] tracking-wide">
                      Request a quote
                    </a>
                  </div>
                </div>
          ...
          {(ref) => (
            <div className="lg:hidden w-full pb-10 mt-3 bg-[#fff] text-black" id="mobile-menu">
              ...
              <a
                ...
                <div className=''>
                <a 
                  href="/quote" className="text-[#000] hover:bg-[#08CEAB] hover:text-black border border-[#08CEAB] mx-auto items-center relative h-10 mt-8 tracking-wider duration-200 px-4 w-full justify-center text-center flex rounded-sm">
                    Request a quote
                 </a>
                </div>
              </div>
          ...
          <div className="flex items-center">
            <div className="flex items-center w-full">
              <div className="flex-shrink-0 md:py-2 items-center duration-500">
                <a href="/">
                  <img width={170} className='items-center hidden md:block lg:block duration-500' src='./white-logo.png' alt='favicon.png'/>
                  <img width={160} className='items-center md:hidden block lg:hidden duration-500' src='./white-logo.png' alt='favicon.png'/>
                </a>
              </div>
              <div className="hidden lg:block w-full duration-500 scroll-smooth">
                <div className="items-center flex duration-500 justify-end mx-auto gap-x-10">
                  <div className='flex pl-8 items-center'>
                    <a
                      ...
                      items-center text-base md:hover:border-b border-[#08CEAB] relative h-8 pt-0.5 duration-200 lg:px-4 md:px-2 px-4 flex justify-center flex-row text-[#fff] tracking-wide"
                    >
                      Home
                    </a>
                  ...
                  <div>
                    <a 
                      href="/quote" className="items-center text-base md:hover:border-b bg-[#08CEAB] border-[#08CEAB] relative h-8 pt-0.5 duration-200 rounded-lg md:px-4 px-4 flex justify-center flex-row text-[#000] tracking-wide">
                      Request a quote
                    </a>
                  </div>
                </div>
            ...
            <div className="mr-2 flex lg:hidden">
              <button
                onClick={() => setIsOpen(!isOpen)}
                type="button"
                className="py-3 inline-flex items-center justify-center duration-500 rounded-md text-[#08CEAB]"
                aria-controls="mobile-menu"
                aria-expanded="false"
              >
                <span className="sr-only">Open main menu</span>
          ...
          {(ref) => (
            <div className="lg:hidden w-full pb-10 mt-3 bg-[#121212] text-white" id="mobile-menu">
              ...
              <a
                ...
                <div className=''>
                <a 
                  href="/quote" className="text-[#fff] hover:bg-[#08CEAB] hover:text-black border border-[#08CEAB] mx-auto items-center relative h-10 mt-8 tracking-wider duration-200 px-4 w-full justify-center text-center flex rounded-sm">
                    Request a quote
                 </a>
                </div>
              </div>
