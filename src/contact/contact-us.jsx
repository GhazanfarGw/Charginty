            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='mx-auto'>
                    ...
                    <div className='items-center'>
                        <button type="submit" disabled={isLoading} className='bg-[#2AE785] px-10 tracking-wider py-2 md:mt-10 mt-5 text-black'>
                            {isLoading ? 'Loading...' : 'Submit'}
                        </button>
                    </div>
                </div>}
                {isSuccess && <p className='justify-center mx-auto text-center pt-10 font-semibold text-[#2AE785]'>Email sent successfully!</p>}
